...
std::string diff_goal_topic, goal_topic, odom_topic;
...
void diff_goal_cb(const nav_msgs::Odometry::ConstPtr msg)
{
    ROS_INFO("Got diff goal x:%f y:%f z:%f",odom_msg.pose.pose.position.x,odom_msg.pose.pose.position.y,odom_msg.pose.pose.position.z);
    ...
    diff_goal_transform.translate(Eigen::Vector3d(msg->pose.pose.position.x, msg->pose.pose.position.y, msg->pose.pose.position.z));
    diff_goal_transform.rotate(Eigen::Quaterniond(msg->pose.pose.orientation.w, msg->pose.pose.orientation.x, msg->pose.pose.orientation.y, msg->pose.pose.orientation.z));
...
{
    ros::init(argc, argv, "diff_goal_generator");

    ros::NodeHandle nh, pnh("~");

    pnh.param("diff_goal_topic", diff_goal_topic, std::string("diff_goal"));
    ...
    ros::Subscriber diff_goal_sub = nh.subscribe<nav_msgs::Odometry>(diff_goal_topic, 5, diff_goal_cb);
